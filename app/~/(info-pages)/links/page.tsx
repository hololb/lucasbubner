...
export default function Links() {
    return (
        <div className="flex flex-col">
            <div className="flex">
                <Box src={GitHubDark} size={170} href="https://github.com/bubner/">
                ...
                <Box src={WakaTime} size={50} href="https://wakatime.com/@bubner">
                    <h1 className="flex justify-center items-center flex-col gap-1">
                        WakaTime
                            <Image
                                className="rounded"
                ...
                <Box src={LinkedIn} size={36} href="https://linkedin.com/in/bubner/">
                    <h1 className="flex justify-center items-center flex-col gap-1">
                        LinkedIn
                            <Image
            ...
            <div className="flex w-full">
                <Box src={Proton} size={20} href={"mailto:bubner@p" + "roton.me"} small>
                    <h1>Contact Email</h1>
                    <span className="__clk">(click)</span>
                </Box>
                <Box src={Replit} size={20} href="https://replit.com/@LUCASBUBNER" small>
                    <h1>Replit</h1>
                    <span className="__clk">(click)</span>
                </Box>
                <Box src={Instagram} size={12} href="https://www.instagram.com/lucas.kbubner/" small>
                    <h1>Instagram</h1>
                    <span className="__clk">(click)</span>
                </Box>
            </div>
