...
export default function Technology() {
    ...
    return (
        <>
            <Box src={JavaKotlin} size={100} entryDelay={iter.next().value}>
                <h1>Java &amp; Kotlin</h1>
                <p>
            ...
            <Box src={ReactTypeScript} size={85} entryDelay={iter.next().value}>
            ...
            <Box src={CSharpUnity} size={105} entryDelay={iter.next().value}>
                <h1>C#</h1>
                <p>
            ...
            <Box src={Lambda} size={50} entryDelay={iter.next().value}>
            ...
            <Box src={PythonOutline} size={50} entryDelay={iter.next().value}>
                <h1>Python</h1>
                <p>
            ...
            <Box src={Git} size={120} entryDelay={iter.next().value}>
